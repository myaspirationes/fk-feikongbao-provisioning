...
public class CompanyFunctionModuleService {
    ...
    public Integer addOroEditCompanyFunctionModule(CompanyFunctionModuleDto companyFunctionModuleDto) {
        // 存在、修改状态
        CompanyFunctionModule companyFunctionModule1 = addOroEditCompanyFunctionModuleParameterCheck(companyFunctionModuleDto);
        if (companyFunctionModule1 != null){
            companyFunctionModule1.setStatus(companyFunctionModuleDto.getStatus());
            return companyFunctionModuleMapper.updateByPrimaryKeySelective(companyFunctionModule1);
        }else {
            // 不存在、添加
